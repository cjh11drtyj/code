...
CPF_z = CPF_data['z'][::1]          # CPF位置z数据
SGP4_z = np.array(SGP4_data['z'])   # SGP4位置z数据
...
for l in range(epoch):
    ...
    print('当前Z轴测试集MSE:', mse)

    if min_mse > mse:
        print('.......saving Z-axis BP model.......')
        model.save('./bp_z_model_' + str(epoch) + '_' + str(batch_size) + '.keras')
        min_mse = mse

print('Z轴训练mse:', test_mse)
print('Z轴最小测试集MSE:', min_mse)
